...
let PhatMarker = L.marker([30.430840, -91.378721], {icon: MyMarkerIcon}).addTo(PhatMapFinal).bindPopup('This webmap shows all the tourist venues in Baton Rouge and its owner. Design by Phat Tran.')
